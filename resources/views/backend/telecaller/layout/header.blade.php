        ...
        <div class="search-with-suggestions-w">
            <div class="search-with-suggestions-modal">
                ...
                <div class="search-suggestions-group">
                    ...
                    <div class="ssg-content">
                        <div class="ssg-items ssg-items-list"><a class="ssg-item" href="javascript:">
        ...
        <div class="layout-w">
            <div class="menu-mobile
             menu-activated-on-click color-scheme-dark">
                <div class="mm-logo-buttons-w"><a class="mm-logo" href="javascript:"><img
                ...
                <div class="menu-and-user">
                    ...
                    <ul class="main-menu">
                        <li class="has-sub-menu"><a href="javascript:">
                            ...
                            <ul class="sub-menu">
                                <li><a href="javascript:">Dashboard 1</a></li>
                                <li><a href="javascript:">Crypto Dashboard <strong
                        ...
                        <li class="has-sub-menu"><a href="apps_bank.html">
                            ...
                            <ul class="sub-menu">
                                <li><a href="javascript:">Email Application</a></li>
                        ...
                        <li class="has-sub-menu"><a href="#">
                            ...
                            <ul class="sub-menu">
                                <li><a href="javascript:">Big Profile</a></li>
            ...
            <div class="menu-w color-scheme-light 
                ...
                <div class="logo-w">
                    <a class="logo" href="{{url('telecaller/dashboard')}}">
                ...
                <ul class="main-menu">
                    ...
                    <li class=""><a href="{{url('telecaller/dashboard')}}">
                            <div class="icon-w">
                                <div class="os-icon os-icon-layout"></div>
                            </div><span>Dashboard</span>
                        </a>
                    ...
                    <li class="">
                        <a href="/telecaller/view-appointment">
                            <div class="icon-w">
                                <div class="os-icon os-icon-layers"></div>
