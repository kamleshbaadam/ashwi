<!DOCTYPE html>
<html>
<!-- Mirrored from +9+++light.pinsupreme.com/apps_bank.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 20 Jun 2020 08:54:36 GMT -->
...
<head>
    ...
    <link href="{{ asset('backend/ipd-reception/favicon.png') }}" rel="shortcut icon">
<link href="{{ asset('backend/ipd-reception/apple-touch-icon.png') }}" rel="apple-touch-icon">
<link href="{{ asset('backend/ipd-reception/../fast.fonts.net/cssapi/487b73f1-c2d1-43db-8526-db577e4c822b.html') }}" rel="stylesheet">
<link href="{{ asset('backend/ipd-reception/bower_components/select2/dist/css/select2.min.css') }}" rel="stylesheet">
<link href="{{ asset('backend/ipd-reception/bower_components/bootstrap-daterangepicker/daterangepicker.css') }}" rel="stylesheet">
<link href="{{ asset('backend/ipd-reception/bower_components/dropzone/dist/dropzone.css') }}" rel="stylesheet">
<link href="{{ asset('backend/ipd-reception/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css') }}" rel="stylesheet">
<link href="{{ asset('backend/ipd-reception/bower_components/fullcalendar/dist/fullcalendar.min.css') }}" rel="stylesheet">
<link href="{{ asset('backend/ipd-reception/bower_components/perfect-scrollbar/css/perfect-scrollbar.min.css') }}" rel="stylesheet">
<link href="{{ asset('backend/ipd-reception/bower_components/slick-carousel/slick/slick.css') }}" rel="stylesheet">
<link href="{{ asset('backend/ipd-reception/css/main5739.css?version=4.5.0') }}" rel="stylesheet">
...
<body class="menu-position-top full-screen with-content-panel">
        ...
        <div class="layout-w">
            ...
            <div class="menu-w color-scheme-light 
                ...
                <ul class="main-menu">
                        ...
                        <div class="top-menu-controls">
                            <div class="logged-user-w">
                                <div class="logged-user-i">
                                    <div class="avatar-w"><img alt="" src="'img/Dr-Mihir-Metha-ENT-1.jpg"></div>
                    ...
                    <li class=""><a href="deshboard.html">
                            <div class="icon-w">
                                <div class="os-icon os-icon-layout"></div>
                            </div><span>Dashboard</span>
                        </a>
                    ...
                    <li class="has-sub-menu"><a href="#">
                        ...
                        <div class="sub-menu-w">
                            ...
                            <div class="sub-menu-i">
                                <ul class="sub-menu">
                                    <li><a href="OT_management.html">OT Management</a></li>
                    ...
                    <li class="has-sub-menu"><a href="#">
                            <div class="icon-w">
                                <div class="os-icon os-icon-file-text"></div>
                            </div><span>Ward Management</span>
                        </a>
                        <div class="sub-menu-w">
                            <div class="sub-menu-header">Ward Management</div>
                            <div class="sub-menu-icon"><i class="os-icon os-icon-file-text"></i></div>
                            <div class="sub-menu-i">
                                <ul class="sub-menu">
                    ...
                    <li class="has-sub-menu"><a href="#">
                        ...
                        <div class="sub-menu-w">
                            <div class="sub-menu-header">Billing Management</div>
                            <div class="sub-menu-icon"><i class="os-icon os-icon-file-text"></i></div>
                            <div class="sub-menu-i">
                                <ul class="sub-menu">
                                    <li><a href="Out_patient_invoice.html">Out Patient Invoice</a></li>
                        ...
                        <div class="sub-menu-w">
                            ...
                            <div class="sub-menu-i">
                                <ul class="sub-menu">
                                    ...
                                    <li><a href="collection_report.html">collection report</a></li>
                                    <li><a href="Daily_collection.html">Daily collection</a></li>
                                    <li><a href="billing_overall_report.html">billing_overall report</a></li>
        ...
        <div class="content-i">
            <div class="content-box">
                <div class="element-wrapper compact pt-4">
                    <div class="element-actions"><a class="btn btn-primary btn-primary" href="old_Patients.html "><i
                            ...
                            <table class="table table-padded text-center">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="user-with-avatar"><span>9743710192</span></div>
                                        </td>
                                        <td>
                                            <div class="user-with-avatar"><span>Bad-1</span></div>

                                        </td>
                                        <td>
                                            <div class="smaller lighter">2/2/301 <small>(8:10pm)</small>
                                            </div>
                                        </td>
                                        <td>
                                            <div>Dhruvi</div>
                                        </td>
                                        <td class="nowrap">E.N.T
                                        </td>
                                        <td>Admit</td>


                                        <td class="row-actions"><a href="inpatient_invoice.html"><i
                                                    class="os-icon os-icon-printer"></i></a><a
                                                href="IPD_Add_out_patient_case_memo.html"><i
                                                    class="os-icon os-icon-tasks-checked"></i></a>
                                        </td>

                                        <td class="row-actions"><a href="inpatient_receipt.html"><i
                                                    class="os-icon os-icon-printer"></i></a><a
                                                href="Add_payments2.html"><i
                                                    class="os-icon os-icon-tasks-checked"></i></a>
                                        </td>

                                        <td class="row-actions"><a href="Add_admission.html"><i
                                                    class="os-icon os-icon-ui-49"></i></a><a
                                                href="IPD_Patient_Details.html"><i
                                                    class="os-icon os-icon-ui-44"></i></a>
                                            <a href="IPD_Add_out_patient_case_memo.html"><i
                                                    class="os-icon os-icon-tasks-checked"></i></a>
                                        </td>
    ...
    <script src="{{ asset('backend/ipd-reception/bower_components/jquery/dist/jquery.min.js') }}"></script>
<script src="{{ asset('backend/ipd-reception/bower_components/popper.js/dist/umd/popper.min.js') }}"></script>
<script src="{{ asset('backend/ipd-reception/bower_components/moment/moment.js') }}"></script>
<script src="{{ asset('backend/ipd-reception/bower_components/chart.js/dist/Chart.min.js') }}"></script>
<script src="{{ asset('backend/ipd-reception/bower_components/select2/dist/js/select2.full.min.js') }}"></script>
<script src="{{ asset('backend/ipd-reception/bower_components/jquery-bar-rating/dist/jquery.barrating.min.js') }}"></script>
<script src="{{ asset('backend/ipd-reception/bower_components/ckeditor/ckeditor.js') }}"></script>
<script src="{{ asset('backend/ipd-reception/bower_components/bootstrap-validator/dist/validator.min.js') }}"></script>
<script src="{{ asset('backend/ipd-reception/bower_components/bootstrap-daterangepicker/daterangepicker.js') }}"></script>
<script src="{{ asset('backend/ipd-reception/bower_components/ion.rangeSlider/js/ion.rangeSlider.min.js') }}"></script>
<script src="{{ asset('backend/ipd-reception/bower_components/dropzone/dist/dropzone.js') }}"></script>
<script src="{{ asset('backend/ipd-reception/bower_components/editable-table/mindmup-editabletable.js') }}"></script>
<script src="{{ asset('backend/ipd-reception/bower_components/datatables.net/js/jquery.dataTables.min.js') }}"></script>
<script src="{{ asset('backend/ipd-reception/bower_components/datatables.net-bs/js/dataTables.bootstrap.min.js') }}"></script>
<script src="{{ asset('backend/ipd-reception/bower_components/fullcalendar/dist/fullcalendar.min.js') }}"></script>
<script src="{{ asset('backend/ipd-reception/bower_components/perfect-scrollbar/js/perfect-scrollbar.jquery.min.js') }}"></script>
<script src="{{ asset('backend/ipd-reception/bower_components/tether/dist/js/tether.min.js') }}"></script>
<script src="{{ asset('backend/ipd-reception/bower_components/slick-carousel/slick/slick.min.js') }}"></script>
<script src="{{ asset('backend/ipd-reception/bower_components/bootstrap/js/dist/util.js') }}"></script>
<script src="{{ asset('backend/ipd-reception/bower_components/bootstrap/js/dist/alert.js') }}"></script>
<script src="{{ asset('backend/ipd-reception/bower_components/bootstrap/js/dist/button.js') }}"></script>
<script src="{{ asset('backend/ipd-reception/bower_components/bootstrap/js/dist/carousel.js') }}"></script>
<script src="{{ asset('backend/ipd-reception/bower_components/bootstrap/js/dist/collapse.js') }}"></script>
<script src="{{ asset('backend/ipd-reception/bower_components/bootstrap/js/dist/dropdown.js') }}"></script>
<script src="{{ asset('backend/ipd-reception/bower_components/bootstrap/js/dist/modal.js') }}"></script>
<script src="{{ asset('backend/ipd-reception/bower_components/bootstrap/js/dist/tab.js') }}"></script>
<script src="{{ asset('backend/ipd-reception/bower_components/bootstrap/js/dist/tooltip.js') }}"></script>
<script src="{{ asset('backend/ipd-reception/bower_components/bootstrap/js/dist/popover.js') }}"></script>
<script src="{{ asset('backend/ipd-reception/js/demo_customizer5739.js?version=4.5.0') }}"></script>
<script src="{{ asset('backend/ipd-reception/js/main5739.js?version=4.5.0') }}"></script>
<script>
    ...
    })(window, document, 'script', '{{ asset('backend/ipd-reception/../www.google-analytics.com/analytics.js') }}', 'ga');
