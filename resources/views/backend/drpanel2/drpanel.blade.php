...
<head>
    ...
    <link href="{{ asset('backend/drpanel2/favicon.png') }}" rel="shortcut icon">
    <link href="{{ asset('backend/drpanel2/apple-touch-icon.png') }}" rel="apple-touch-icon">
    <link href="{{ asset('backend/drpanel2/../fast.fonts.net/cssapi/487b73f1-c2d1-43db-8526-db577e4c822b.html') }}" rel="stylesheet">
    <link href="{{ asset('backend/drpanel2/bower_components/select2/dist/css/select2.min.css') }}" rel="stylesheet">
    <link href="{{ asset('backend/drpanel2/bower_components/bootstrap-daterangepicker/daterangepicker.css') }}" rel="stylesheet">
    <link href="{{ asset('backend/drpanel2/bower_components/dropzone/dist/dropzone.css') }}" rel="stylesheet">
    <link href="{{ asset('backend/drpanel2/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css') }}" rel="stylesheet">
    <link href="{{ asset('backend/drpanel2/bower_components/fullcalendar/dist/fullcalendar.min.css') }}" rel="stylesheet">
    <link href="{{ asset('backend/drpanel2/bower_components/perfect-scrollbar/css/perfect-scrollbar.min.css') }}" rel="stylesheet">
    <link href="{{ asset('backend/drpanel2/bower_components/slick-carousel/slick/slick.css') }}" rel="stylesheet">
    <link href="{{ asset('backend/drpanel2/css/main5739.css?version=4.5.0') }}" rel="stylesheet">
...
<body class="menu-position-top full-screen with-content-panel">
            ...
            <div class="menu-w color-scheme-light 
                ...
                <ul class="main-menu">
                    ...
                    <li class="has-sub-menu"><a href="#">
                            <div class="icon-w">
                                <div class="os-icon os-icon-file-text"></div>
                            </div><span>OT Schedule</span>
                        </a>
                        <div class="sub-menu-w">
                            <div class="sub-menu-header">OT Schedule</div>
                            <div class="sub-menu-icon"><i class="os-icon os-icon-file-text"></i></div>
                            <div class="sub-menu-i">
                                <ul class="sub-menu">
                                    <li><a href="OT_schedule.html">OT Schedule</a></li>
                                    <li><a href="New_Sargary_viewpage.html">New Sargary</a></li>
                ...
                <div class="content-w" style="margin-top: -50px;">
                    <div class="content-i">
                        <div class="content-box">
                            ...
                            <div class="element-wrapper  pt-4">
                                <div class="element-wrapper">
                                    <div class="element-actions"><a class="btn btn-primary btn-primary"
                                            href="New_Sargary_viewpage.html">
                                            <!-- <i class="os-icon os-icon-ui-22"></i> -->
                                            <span>View all</span></a></div>

                                    <h6 class="element-header">New Sargary</h6>
                                                        ...
                                                        <td class="">
                                                            <div class="">
                                                                <a class="btn btn-primary btn-primary"
                                                                    href="Dr_panel2.html" style="color: white;"><span>
                                                                        <i
                                                                            class="os-icon os-icon-grid-10"></i></span></a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                            ...
                            <div class="element-wrapper" style="margin-top: -80px;">


                                <div class="element-actions"><a class="btn btn-primary btn-primary"
                                        href="OT_Schedule_viewpage.html">
                                        <!-- <i class="os-icon os-icon-ui-22"></i> -->
                                        <span>View all</span></a></div>
    ...
    <script src="{{ asset('backend/drpanel2/bower_components/jquery/dist/jquery.min.js') }}"></script>
<script src="{{ asset('backend/drpanel2/bower_components/popper.js/dist/umd/popper.min.js') }}"></script>
<script src="{{ asset('backend/drpanel2/bower_components/moment/moment.js') }}"></script>
<script src="{{ asset('backend/drpanel2/bower_components/chart.js/dist/Chart.min.js') }}"></script>
<script src="{{ asset('backend/drpanel2/bower_components/select2/dist/js/select2.full.min.js') }}"></script>
<script src="{{ asset('backend/drpanel2/bower_components/jquery-bar-rating/dist/jquery.barrating.min.js') }}"></script>
<script src="{{ asset('backend/drpanel2/bower_components/ckeditor/ckeditor.js') }}"></script>
<script src="{{ asset('backend/drpanel2/bower_components/bootstrap-validator/dist/validator.min.js') }}"></script>
<script src="{{ asset('backend/drpanel2/bower_components/bootstrap-daterangepicker/daterangepicker.js') }}"></script>
<script src="{{ asset('backend/drpanel2/bower_components/ion.rangeSlider/js/ion.rangeSlider.min.js') }}"></script>
<script src="{{ asset('backend/drpanel2/bower_components/dropzone/dist/dropzone.js') }}"></script>
<script src="{{ asset('backend/drpanel2/bower_components/editable-table/mindmup-editabletable.js') }}"></script>
<script src="{{ asset('backend/drpanel2/bower_components/datatables.net/js/jquery.dataTables.min.js') }}"></script>
<script src="{{ asset('backend/drpanel2/bower_components/datatables.net-bs/js/dataTables.bootstrap.min.js') }}"></script>
<script src="{{ asset('backend/drpanel2/bower_components/fullcalendar/dist/fullcalendar.min.js') }}"></script>
<script src="{{ asset('backend/drpanel2/bower_components/perfect-scrollbar/js/perfect-scrollbar.jquery.min.js') }}"></script>
<script src="{{ asset('backend/drpanel2/bower_components/tether/dist/js/tether.min.js') }}"></script>
<script src="{{ asset('backend/drpanel2/bower_components/slick-carousel/slick/slick.min.js') }}"></script>
<script src="{{ asset('backend/drpanel2/bower_components/bootstrap/js/dist/util.js') }}"></script>
<script src="{{ asset('backend/drpanel2/bower_components/bootstrap/js/dist/alert.js') }}"></script>
<script src="{{ asset('backend/drpanel2/bower_components/bootstrap/js/dist/button.js') }}"></script>
<script src="{{ asset('backend/drpanel2/bower_components/bootstrap/js/dist/carousel.js') }}"></script>
<script src="{{ asset('backend/drpanel2/bower_components/bootstrap/js/dist/collapse.js') }}"></script>
<script src="{{ asset('backend/drpanel2/bower_components/bootstrap/js/dist/dropdown.js') }}"></script>
<script src="{{ asset('backend/drpanel2/bower_components/bootstrap/js/dist/modal.js') }}"></script>
<script src="{{ asset('backend/drpanel2/bower_components/bootstrap/js/dist/tab.js') }}"></script>
<script src="{{ asset('backend/drpanel2/bower_components/bootstrap/js/dist/tooltip.js') }}"></script>
<script src="{{ asset('backend/drpanel2/bower_components/bootstrap/js/dist/popover.js') }}"></script>
<script src="{{ asset('backend/drpanel2/js/demo_customizer5739.js?version=4.5.0') }}"></script>
<script src="{{ asset('backend/drpanel2/js/main5739.js?version=4.5.0') }}"></script>
<script>(function (i, s, o, g, r, a, m) {
        i['GoogleAnalyticsObject'] = r; i[r] = i[r] || function () {
            (i[r].q = i[r].q || []).push(arguments)
        }, i[r].l = 1 * new Date(); a = s.createElement(o),
            m = s.getElementsByTagName(o)[0]; a.async = 1; a.src = g; m.parentNode.insertBefore(a, m)
    })(window, document, 'script', '{{ asset('backend/drpanel2/../www.google-analytics.com/analytics.js') }}', 'ga');
