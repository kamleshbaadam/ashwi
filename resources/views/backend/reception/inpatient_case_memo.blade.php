...
@push('title')
<title>In Patient Case Memo</title>
@endpush
                                ...
                                <div class="element-box">
                                    <form>
                                        <div class="element-actions"><a class="btn btn-primary btn-primary"
                                                href="Patients.html"><i class="os-icon os-icon-ui-22"></i><span>Add Case
                                                    Memo</span></a>
                                        </div>


                                        <h6 class="element-header">IN-Patients Case Memo</h6>
