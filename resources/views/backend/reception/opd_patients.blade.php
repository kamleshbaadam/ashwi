                        ...
                        <div class="col-lg-12">
                            <div class="element-wrapper">
                                ...
                                <div class="element-box">
                                    <form>
                                        <h5 class="form-header">OPD Patient</h5>

                                        <div class="form-buttons-w form-desc"><a class="btn btn-primary" type="submit"
                                                href="/opd-patients">
                                                OPD patient</a>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="row col-sm-6">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group"><select class="form-control">
                                                            <option>Operating  Doctor</option>
                                                            <option>Receptionist</option>
                                                            <option>Bed Manager</option>
                                                            <option>Laboratory</option>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group"><select class="form-control">
                                                            <option>Select Anesthesia</option>
                                                            <option>Receptionist</option>
                                                            <option>Bed Manager</option>
                                                            <option>Laboratory</option>
