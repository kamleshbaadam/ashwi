...
@push('title')
<title>Billing Overall Report</title>
@endpush
                        ...
                        <div class="col-lg-12">
                            <div class="element-wrapper">
                                ...
                                <div class="element-box">
                                    <form>
                                        <h5 class="form-header">Billing Overall Report</h5>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        ...
                                                        <label class="form-check-label" for="inlineRadio1">Revenue
                                                            Report</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            name="inlineRadioOptions" id="inlineRadio1" value="option1">
                                                        <label class="form-check-label" for="inlineRadio1">Case 
                                                            Flow </label>
                                                    </div>
