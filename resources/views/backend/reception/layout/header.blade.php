    ...
    <div class="layout-w">
        ...
        <div class="menu-w color-scheme-light 
            ...
            <ul class="main-menu">
                    ...
                    <div class="top-menu-controls">
                        <div class="logged-user-w">
                            <div class="logged-user-i">
                                <div class="avatar-w"><img alt="" src="{{ asset('backend/reception/img/Dr-Mihir-Metha-ENT-1.jpg') }}"></div>
                ...
                <li class=""><a href="{{url('reception/dashboard')}}">
                        <div class="icon-w">
                            <div class="os-icon os-icon-layout"></div>
                        </div><span>Dashboard</span>
                    </a>
                ...
                <li class="">
                    <a href="{{url('reception/patientList')}}">
                        <div class="icon-w">
                            <div class="os-icon os-icon-layout"></div>
