...
<body class="menu-position-top full-screen with-content-panel">
    ...
    <!-- START: Header -->
    @include('backend.reception.layout.header')
    ...
    <script src="{{ asset('backend/reception/bower_components/bootstrap/js/dist/alert.js') }}"></script>
    <script src="{{ asset('backend/reception/bower_components/bootstrap/js/dist/button.js') }}"></script>
    <script src="{{ asset('backend/reception/bower_components/bootstrap/js/dist/carousel.js') }}"></script>
    <script src="{{ asset('backend/reception/bower_components/bootstrap/js/dist/collapse.js') }}"></script>
    <script src="{{ asset('backend/reception/bower_components/bootstrap/js/dist/dropdown.js') }}"></script>
    <script src="{{ asset('backend/reception/bower_components/bootstrap/js/dist/modal.js') }}"></script>
    <script src="{{ asset('backend/reception/bower_components/bootstrap/js/dist/tab.js') }}"></script>
    <script src="{{ asset('backend/reception/bower_components/bootstrap/js/dist/tooltip.js') }}"></script>
    <script src="{{ asset('backend/reception/bower_components/bootstrap/js/dist/popover.js') }}"></script>
    <script src="{{ asset('backend/reception/js/demo_customizer5739.js?version=4.5.0') }}"></script>
    <script src="{{ asset('backend/reception/js/main5739.js?version=4.5.0') }}"></script>
