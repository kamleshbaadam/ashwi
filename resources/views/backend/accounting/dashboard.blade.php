...
<head>
    ...
    <link href="{{ asset('backend/accounting/favicon.png') }}" rel="shortcut icon">
<link href="{{ asset('backend/accounting/apple-touch-icon.png') }}" rel="apple-touch-icon">
<link href="{{ asset('backend/accounting/fast.fonts.net/cssapi/487b73f1-c2d1-43db-8526-db577e4c822b.html') }}" rel="stylesheet">
<link href="{{ asset('backend/accounting/bower_components/select2/dist/css/select2.min.css') }}" rel="stylesheet">
<link href="{{ asset('backend/accounting/bower_components/bootstrap-daterangepicker/daterangepicker.css') }}" rel="stylesheet">
<link href="{{ asset('backend/accounting/bower_components/dropzone/dist/dropzone.css') }}" rel="stylesheet">
<link href="{{ asset('backend/accounting/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css') }}" rel="stylesheet">
<link href="{{ asset('backend/accounting/bower_components/fullcalendar/dist/fullcalendar.min.css') }}" rel="stylesheet">
<link href="{{ asset('backend/accounting/bower_components/perfect-scrollbar/css/perfect-scrollbar.min.css') }}" rel="stylesheet">
<link href="{{ asset('backend/accounting/bower_components/slick-carousel/slick/slick.css') }}" rel="stylesheet">
<link href="{{ asset('backend/accounting/css/main5739.css?version=4.5.0') }}" rel="stylesheet">
...
<body class="menu-position-side menu-side-left full-screen">
    <div class="all-wrapper solid-bg-all">
        <div class="top-bar color-scheme-bright">
            <div class="logo-w menu-size"><a class="logo" href="#">
        ...
        <div class="layout-w">
            <div class="menu-mobile menu-activated-on-click color-scheme-dark">
                <div class="mm-logo-buttons-w"><a class="mm-logo" href="index-2.html"><img
                            src="img/logo.png"><span>Aashwi Hospital</span></a>
                ...
                <div class="menu-and-user">
                    <div class="logged-user-w">
                        <div class="avatar-w"><img alt="" src="img/avatar8.png"></div>
                    ...
                    <ul class="main-menu">
                        <li class="has-sub-menu"><a href="index-2.html">
                                <div class="icon-w">
            ...
            <div
                ...
                <ul class="main-menu">
                    ...
                    <li class="selected has-sub-menu"><a href="dashboard.html">
                            <div class="icon-w">
                                <div class="os-icon os-icon-layout"></div>
                            </div><span>Dashboard</span>
                        </a>
                    ...
                    <li class="has-sub-menu"><a href="appointment.html">
                        ...
                        <div class="sub-menu-w">
                            <div class="sub-menu-header">appointment</div>
                            <div class="sub-menu-icon"><i class="os-icon os-icon-layers"></i></div>
                            <div class="sub-menu-i">
                                <ul class="sub-menu">
                                    <li><a href="appointment.html">appointment</a></li>
                                    <li><a href="add_new_opd.html">Add Patients</a></li>
                                    <li><a href="Temporary_Appoinment.html">Temporary Appoinment</a></li>
                        ...
                        <div class="sub-menu-w">
                            ...
                            <div class="sub-menu-i">
                                <ul class="sub-menu">
                                    ...
                                    <li><a href="OPD_patients.html">OPD</a></li>
                                    <li><a href="IPD_patients.html">IPD</a></li>
                    ...
                    <li class="has-sub-menu"><a href="#">
                            <div class="icon-w">
                                <div class="os-icon os-icon-life-buoy"></div>
                            </div><span>Ward Managemnt</span>
                        </a>
                        <div class="sub-menu-w">
                            <div class="sub-menu-header">Ward Managemnt</div>
                            <div class="sub-menu-icon"><i class="os-icon os-icon-life-buoy"></i></div>
                            <div class="sub-menu-i">
                                <ul class="sub-menu">
                                    <li><a href="Delux_ward.html">Delux Ward</a></li>
                                    <li><a href="ATD.html">ATD</a></li>
                                    
                                    <li><a href="ward.html">Ward list</a></li>
                    ...
                    <li class="has-sub-menu"><a href="#">
                            <div class="icon-w">
                                <div class="os-icon os-icon-mail"></div>
                            </div><span>Billing Management</span>
                        </a>
                        <div class="sub-menu-w">
                            <div class="sub-menu-header">Billing </div>
                            <div class="sub-menu-icon"><i class="os-icon os-icon-life-buoy"></i></div>
                            <div class="sub-menu-i">
                                <ul class="sub-menu">
                                    <li><a href="Out_patient_invoice.html">Out patient Out Patient Invoice</a></li>
                                    <li><a href="Out_patient_Receipt.html">Out Patient Receipt</a></li>
                                    <li><a href="inpatients_advance.html">Inpatients Advance</a></li>
                                    <li><a href="IN_Patient_case_Memo.html">IN Patient Case Memo</a></li>
                                    <li><a href="Add_IPD_Advance.html">Add IPD Advance</a></li>
                    ...
                    <li class="has-sub-menu"><a href="#">
                        ...
                        <div class="sub-menu-w">
                            <div class="sub-menu-header">Data Analytics</div>
                            <div class="sub-menu-icon"><i class="os-icon os-icon-users"></i></div>
                            <div class="sub-menu-i">
                                <ul class="sub-menu">
                                    <li><a href="3C_report.html">3C Report</a></li>
                                    <li><a href="IPD_Report.html">IPD Report</a></li>
                                    <li><a href="Collection_Report_Add.html">Add Collection Report </a></li>
                                    <li><a href="Daily_collection.html">Daily Collection </a></li>
                                    <li><a href="billing_overall_report.html">Billing Overall Report</a></li>
                                    <li><a href="Master_Date.html">Master Date</a></li>
            ...
            <div class="content-i">
                <div class="content-box">
                    <div class="element-wrapper compact pt-4">
                        <div class="element-actions"><a class="btn btn-primary btn-sm" href="#"><i
                                    class="os-icon os-icon-ui-22"></i><span>Add Staff</span></a><a
                                class="btn btn-success btn-sm" href="#"><i
                                    class="os-icon os-icon-grid-10"></i><span>View OPD </span></a></div>
                            ...
                            <div class="element-wrapper">
                                <div class="element-box">
                                    ...
                                    <div class="el-tablo bigger highlight bold-label">
                                        <div class="value">₹ 5,12,537</div>
                                        <div class="label">Amount</div>
                                    </div>
                                    <div class="el-chart-w"><canvas data-chart-data="13,28,19,24,43,49,40,35,42,46"
                                            height="90" id="liteLineChartV2" width="300"></canvas></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-7 col-xxl-6">
                            <div class="element-wrapper">
                                <div class="element-box">
                                    ...
                                    <h5 class="element-box-header">Total Patients</h5>
                                    <div class="el-tablo bigger highlight bold-label">
                                        <div class="value">12,537</div>
                                        <div class="label">Unique Visitors</div>
                                    </div>
                                    <div class="el-chart-w"><canvas height="170px" id="lineChart"
                                            width="600px"></canvas></div>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <tbody>
                                <tr>
                                    <td class="text-center">
                                        1 </td>
                                    <td>
                                        <div class="user-with-avatar"><span>kenneeth chritian</span>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="smaller lighter">op28743</div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="smaller lighter">male</div>
                                    </td>

                                    <td>
                                        <div class="smaller lighter">Follow-Up</div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="smaller lighter">2:20 Am</div>
                                    </td>
                                    <td class="nowrap"><span class="status-pill smaller green"></span><span>Start</span>
                                    </td>
                                    <td class="row-actions"><a href="#"><i class="os-icon os-icon-grid-10"></i></a><a
                                            href="#"><i class="os-icon os-icon-ui-44"></i></a><a class="danger"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="smaller lighter">Female</div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="smaller lighter">Nose</div>
                                    </td>
                                    <td>
                                        <div class="smaller lighter"></div>
                                    </td>
                                    ...
                                    <td class="nowrap"><span
                                            class="status-pill smaller red"></span><span>Finished</span>
                                    </td>
                                    <td class="row-actions"><a href="#"><i class="os-icon os-icon-grid-10"></i></a><a
                                            href="#"><i class="os-icon os-icon-ui-44"></i></a><a class="danger"
                                            href="#"><i class="os-icon os-icon-ui-15"></i></a></td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="smaller lighter">Dr.Mihir</div>
                                    </td>
                                    <td>
                                        <div class="smaller lighter">2:20 Am</div>
                                    </td>
    ...
    <script src="{{ asset('backend/accounting/bower_components/jquery/dist/jquery.min.js') }}"></script>
<script src="{{ asset('backend/accounting/bower_components/popper.js/dist/umd/popper.min.js') }}"></script>
<script src="{{ asset('backend/accounting/bower_components/moment/moment.js') }}"></script>
<script src="{{ asset('backend/accounting/bower_components/chart.js/dist/Chart.min.js') }}"></script>
<script src="{{ asset('backend/accounting/bower_components/select2/dist/js/select2.full.min.js') }}"></script>
<script src="{{ asset('backend/accounting/bower_components/jquery-bar-rating/dist/jquery.barrating.min.js') }}"></script>
<script src="{{ asset('backend/accounting/bower_components/ckeditor/ckeditor.js') }}"></script>
<script src="{{ asset('backend/accounting/bower_components/bootstrap-validator/dist/validator.min.js') }}"></script>
<script src="{{ asset('backend/accounting/bower_components/bootstrap-daterangepicker/daterangepicker.js') }}"></script>
<script src="{{ asset('backend/accounting/bower_components/ion.rangeSlider/js/ion.rangeSlider.min.js') }}"></script>
<script src="{{ asset('backend/accounting/bower_components/dropzone/dist/dropzone.js') }}"></script>
<script src="{{ asset('backend/accounting/bower_components/editable-table/mindmup-editabletable.js') }}"></script>
<script src="{{ asset('backend/accounting/bower_components/datatables.net/js/jquery.dataTables.min.js') }}"></script>
<script src="{{ asset('backend/accounting/bower_components/datatables.net-bs/js/dataTables.bootstrap.min.js') }}"></script>
<script src="{{ asset('backend/accounting/bower_components/fullcalendar/dist/fullcalendar.min.js') }}"></script>
<script src="{{ asset('backend/accounting/bower_components/perfect-scrollbar/js/perfect-scrollbar.jquery.min.js') }}"></script>
<script src="{{ asset('backend/accounting/bower_components/tether/dist/js/tether.min.js') }}"></script>
<script src="{{ asset('backend/accounting/bower_components/slick-carousel/slick/slick.min.js') }}"></script>
<script src="{{ asset('backend/accounting/bower_components/bootstrap/js/dist/util.js') }}"></script>
<script src="{{ asset('backend/accounting/bower_components/bootstrap/js/dist/alert.js') }}"></script>
<script src="{{ asset('backend/accounting/bower_components/bootstrap/js/dist/button.js') }}"></script>
<script src="{{ asset('backend/accounting/bower_components/bootstrap/js/dist/carousel.js') }}"></script>
<script src="{{ asset('backend/accounting/bower_components/bootstrap/js/dist/collapse.js') }}"></script>
<script src="{{ asset('backend/accounting/bower_components/bootstrap/js/dist/dropdown.js') }}"></script>
<script src="{{ asset('backend/accounting/bower_components/bootstrap/js/dist/modal.js') }}"></script>
<script src="{{ asset('backend/accounting/bower_components/bootstrap/js/dist/tab.js') }}"></script>
<script src="{{ asset('backend/accounting/bower_components/bootstrap/js/dist/tooltip.js') }}"></script>
<script src="{{ asset('backend/accounting/bower_components/bootstrap/js/dist/popover.js') }}"></script>
<script src="{{ asset('backend/accounting/js/demo_customizer5739.js?version=4.5.0') }}"></script>
<script src="{{ asset('backend/accounting/js/main5739.js?version=4.5.0') }}"></script>
...
<script>
    ...
    })(window, document, 'script', '{{ asset('backend/accounting/www.google-analytics.com/analytics.js') }}', 'ga');
