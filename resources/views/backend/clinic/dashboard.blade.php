...
<head>
    ...
    <link href="{{ asset('backend/clinic/favicon.png') }}" rel="shortcut icon">
    <link href="{{ asset('backend/clinic/apple-touch-icon.png') }}" rel="apple-touch-icon">
    <link href="{{ asset('backend/clinic/fast.fonts.net/cssapi/487b73f1-c2d1-43db-8526-db577e4c822b.html') }}" rel="stylesheet">
    <link href="{{ asset('backend/clinic/bower_components/select2/dist/css/select2.min.css') }}" rel="stylesheet">
    <link href="{{ asset('backend/clinic/bower_components/bootstrap-daterangepicker/daterangepicker.css') }}" rel="stylesheet">
    <link href="{{ asset('backend/clinic/bower_components/dropzone/dist/dropzone.css') }}" rel="stylesheet">
    <link href="{{ asset('backend/clinic/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css') }}" rel="stylesheet">
    <link href="{{ asset('backend/clinic/bower_components/fullcalendar/dist/fullcalendar.min.css') }}" rel="stylesheet">
    <link href="{{ asset('backend/clinic/bower_components/perfect-scrollbar/css/perfect-scrollbar.min.css') }}" rel="stylesheet">
    <link href="{{ asset('backend/clinic/bower_components/slick-carousel/slick/slick.css') }}" rel="stylesheet">
    <link href="{{ asset('backend/clinic/css/main5739.css?version=4.5.0') }}" rel="stylesheet">
...
<body class="menu-position-top full-screen with-content-panel">
    <div class="all-wrapper with-side-panel solid-bg-all">
                ...
                <ul class="main-menu">
                        ...
                        <div class="sub-menu-w">
                            ...
                            <div class="sub-menu-i">
                                <ul class="sub-menu">
                                    ...
                                    <li><a href="add_new_opd.html">Add patient</a></li>
                    ...
                    <li class="has-sub-menu"><a href="#">
                        ...
                        <div class="sub-menu-w">
                            ...
                            <div class="sub-menu-i">
                                <ul class="sub-menu">
                                    <li><a href="Delux_ward.html">Dulux Ward </a></li>
        ...
        <div class="content-w" style="margin-top: -50px;">
                        ...
                        <div class="table-responsive">
                            ...
                            <div class="element-wrapper compact pt-4">
                                <div class="element-actions"><a class="btn btn-primary btn-sm"
                                        href="add_new_opd.html"><i class="os-icon os-icon-ui-22"></i><span>Add
                                            Appointment</span></a><a class="btn btn-success btn-sm" href="OPD.html"><i
                                            class="os-icon os-icon-grid-10"></i><span>View Appointment </span></a></div>
                                <h6 class="element-header">Waiting OPD Appointment</h6>
                                <table class="table table-padded">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="smaller lighter">Dr Mihir Mehta</div>
                                            </td>
                                            ...
                                            <td class="nowrap"><span>
                                                    <div class=""><a class="btn btn-primary btn-primary"
                                                            href="add.opd.html" style="color: white;"><span>
                                                                Start Diagnos</span></a></div>
                                                </span>
                                            </td>
                                            <td class="row-actions"><a href="add_new_opd.html"><i
                                                        class="os-icon os-icon-grid-10"></i></a><a
                                                    href="view_opd.html"><i class="os-icon os-icon-ui-44"></i></a><a
                                                    class="danger" href="#"><i class="os-icon os-icon-ui-15"></i></a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="text-center">
                            ...
                            <div class="table-responsive">
                                <h6>Completed OPD Appointment</h6>
                                <table class="table table-padded">
                                    <thead>
                                        <tr>
                                            <th>SR</th>
            ...
            <script src="{{ asset('backend/clinic/bower_components/jquery/dist/jquery.min.js') }}"></script>
            <script src="{{ asset('backend/clinic/bower_components/popper.js/dist/umd/popper.min.js') }}"></script>
            <script src="{{ asset('backend/clinic/bower_components/moment/moment.js') }}"></script>
            <script src="{{ asset('backend/clinic/bower_components/chart.js/dist/Chart.min.js') }}"></script>
            <script src="{{ asset('backend/clinic/bower_components/select2/dist/js/select2.full.min.js') }}"></script>
            <script src="{{ asset('backend/clinic/bower_components/jquery-bar-rating/dist/jquery.barrating.min.js') }}"></script>
            <script src="{{ asset('backend/clinic/bower_components/ckeditor/ckeditor.js') }}"></script>
            <script src="{{ asset('backend/clinic/bower_components/bootstrap-validator/dist/validator.min.js') }}"></script>
            <script src="{{ asset('backend/clinic/bower_components/bootstrap-daterangepicker/daterangepicker.js') }}"></script>
            <script src="{{ asset('backend/clinic/bower_components/ion.rangeSlider/js/ion.rangeSlider.min.js') }}"></script>
            <script src="{{ asset('backend/clinic/bower_components/dropzone/dist/dropzone.js') }}"></script>
            <script src="{{ asset('backend/clinic/bower_components/editable-table/mindmup-editabletable.js') }}"></script>
            <script src="{{ asset('backend/clinic/bower_components/datatables.net/js/jquery.dataTables.min.js') }}"></script>
            <script src="{{ asset('backend/clinic/bower_components/datatables.net-bs/js/dataTables.bootstrap.min.js') }}"></script>
            <script src="{{ asset('backend/clinic/bower_components/fullcalendar/dist/fullcalendar.min.js') }}"></script>
            <script src="{{ asset('backend/clinic/bower_components/perfect-scrollbar/js/perfect-scrollbar.jquery.min.js') }}"></script>
            <script src="{{ asset('backend/clinic/bower_components/tether/dist/js/tether.min.js') }}"></script>
            <script src="{{ asset('backend/clinic/bower_components/slick-carousel/slick/slick.min.js') }}"></script>
            <script src="{{ asset('backend/clinic/bower_components/bootstrap/js/dist/util.js') }}"></script>
            <script src="{{ asset('backend/clinic/bower_components/bootstrap/js/dist/alert.js') }}"></script>
            <script src="{{ asset('backend/clinic/bower_components/bootstrap/js/dist/button.js') }}"></script>
            <script src="{{ asset('backend/clinic/bower_components/bootstrap/js/dist/carousel.js') }}"></script>
            <script src="{{ asset('backend/clinic/bower_components/bootstrap/js/dist/collapse.js') }}"></script>
            <script src="{{ asset('backend/clinic/bower_components/bootstrap/js/dist/dropdown.js') }}"></script>
            <script src="{{ asset('backend/clinic/bower_components/bootstrap/js/dist/modal.js') }}"></script>
            <script src="{{ asset('backend/clinic/bower_components/bootstrap/js/dist/tab.js') }}"></script>
            <script src="{{ asset('backend/clinic/bower_components/bootstrap/js/dist/tooltip.js') }}"></script>
            <script src="{{ asset('backend/clinic/bower_components/bootstrap/js/dist/popover.js') }}"></script>
            <script src="{{ asset('backend/clinic/js/demo_customizer5739.js?version=4.5.0') }}"></script>
            <script src="{{ asset('backend/clinic/js/main5739.js?version=4.5.0') }}"></script>
            ...
            <script>
                ...
                })(window, document, 'script', '{{ asset('backend/clinic/www.google-analytics.com/analytics.js') }}', 'ga');
