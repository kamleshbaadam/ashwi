                                            ...
                                            <tbody class="text-center">
                                                <tr>
                                                    ...
                                                    <td class="nowrap"><span
                                                            class="status-pill smaller red"></span><span>Queue</span>
                                                    </td>
                                                    <td class="">
                                                        <div class="">
                                                            <a class="btn btn-primary btn-primary"
                                                                href="/drpanel/add-new-opdpage" style="color: white;"><span>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="">
                                                        <div class="">
                                                            <a class="btn btn-primary btn-primary"
                                                                href="/add-new-opdpage" style="color: white;"><span>
                                                                    <i class="os-icon os-icon-grid-10"></i></span></a>
                                            ...
                                            <table class="table table-padded text-center">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="nowrap"><span
                                                                class="status-pill smaller red"></span><span>Not
                                                                Paid</span>
                                                        </td>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td class="row-actions"><a
                                                                        href="/drpanel/ipd-patient-details">
                                                                        <i class="os-icon os-icon-ui-44"></i></a><a
                                                                        class="danger" href="#"><i
