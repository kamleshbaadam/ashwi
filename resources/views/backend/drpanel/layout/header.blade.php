    ...
    <div class="layout-w">
        <div class="menu-mobile
         menu-activated-on-click color-scheme-dark">
            <div class="mm-logo-buttons-w"><a class="mm-logo" href="index-2.html"><img src="{{url('backend/drpanel/img/logo.png') }}"><span>Clean Admin</span></a>
            ...
            <div class="menu-and-user">
                <div class="logged-user-w">
                    <div class="avatar-w"><img alt="" src="{{url('backend/drpanel/img/avatar1.jpg')}}"></div>
                ...
                <ul class="main-menu">
                    ...
                    <li class="has-sub-menu"><a href="#">
                        ...
                        <ul class="sub-menu">
                            <li><a href="uikit_modals.html">Modals <strong class="badge badge-danger">New</strong></a>
                            </li>
        ...
        <div
            class="menu-w color-scheme-light
            ...
            <div class="logo-w"><a class="logo" href="/drpanel">
                                ...
                                <div class="logged-user-i">
                                    ...
                                    <div class="logged-user-menu color-style-bright">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="javascript:" onclick="logoutfun();"><i
                ...
                <li class="has-sub-menu"><a href="layouts_menu_top_image.html">
                    ...
                    <div class="sub-menu-w">
                        ...
                        <div class="sub-menu-i">
                            <ul class="sub-menu">
                                <li><a href="/drpanel/opd">Current OPD </a></li>

                                <li><a href="/drpanel/opd-patients">OPD Patients</a></li>
                            </ul>
                        </div>
                    </div>
                </li>
