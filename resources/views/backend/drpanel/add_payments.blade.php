                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="element-wrapper">
                                ...
                                <h6 class="element-header">Add IPD Payment</h6>
                                <div class="element-box">
                                    <form>
                                        <h5 class="form-header">Add IPD Payment</h5>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group"><label for="">Date: </label><input
                                                            class="form-control" placeholder="Docuter"
                                                            type="date">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="form-group"><label for=""> Payment Mode</label><select class="form-control">
                                        ...
                                        <div class="floated-customizer-panel">
                                            <div class="fcp-content">
                                                <div class="close-customizer-btn"><i class="os-icon os-icon-x"></i>
                                                </div>
                                                <div class="fcp-group">
