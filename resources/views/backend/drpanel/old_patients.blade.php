                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="element-wrapper">
                                ...
                                <h6 class="element-header">Old Patient</h6>
                                <div class="element-box">
                                    <form>
                                        <h5 class="form-header">Old Patient</h5>

                                        <div class="form-buttons-w form-desc" style="color: white;">
                                            <a class="btn btn-primary" type="submit" href="/drpanel/add-new-opd">
                                                New patient </a>
                                            ...
                                            <div class="row col-sm-6">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group"><label for="">Duration</label>
                                                        <input class="form-control" type="number" placeholder="5 min">
                                                    </div>
                                                </div>
