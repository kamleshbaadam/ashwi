...
<head>
    ...
    <link href="{{ asset('backend/evaluation/favicon.png') }}" rel="shortcut icon">
    <link href="{{ asset('backend/evaluation/apple-touch-icon.png') }}" rel="apple-touch-icon">
    <link href="{{ asset('backend/evaluation/../fast.fonts.net/cssapi/487b73f1-c2d1-43db-8526-db577e4c822b.html') }}" rel="stylesheet">
    <link href="{{ asset('backend/evaluation/bower_components/select2/dist/css/select2.min.css') }}" rel="stylesheet">
    <link href="{{ asset('backend/evaluation/bower_components/bootstrap-daterangepicker/daterangepicker.css') }}" rel="stylesheet">
    <link href="{{ asset('backend/evaluation/bower_components/dropzone/dist/dropzone.css') }}" rel="stylesheet">
    <link href="{{ asset('backend/evaluation/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css') }}" rel="stylesheet">
    <link href="{{ asset('backend/evaluation/bower_components/fullcalendar/dist/fullcalendar.min.css') }}" rel="stylesheet">
    <link href="{{ asset('backend/evaluation/bower_components/perfect-scrollbar/css/perfect-scrollbar.min.css') }}" rel="stylesheet">
    <link href="{{ asset('backend/evaluation/bower_components/slick-carousel/slick/slick.css') }}" rel="stylesheet">
    <link href="{{ asset('backend/evaluation/css/main5739.css?version=4.5.0') }}" rel="stylesheet">
...
<body class="menu-position-side menu-side-left full-screen">
    <div class="all-wrapper with-side-panel solid-bg-all">
        ...
        <div class="content-w" style="margin-top: -60px;">
            <div class="content-i">
                <div class="content-box">
                    <div class="element-wrapper compact pt-4">
                        <div class="element-actions">
                            <a class="btn btn-primary btn-primary" href="OT_schedule.html"><i
                                    class="os-icon os-icon-ui-22"></i><span>View All</span></a>
                        </div>
                                    ...
                                    <table class="table table-padded text-center">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="smaller ">2/2/301</div>
                                                </td>
                                                <td>
                                                    <div class="smaller ">2/2/301</div>
                                                </td>
                                                <td>
                                                    <div class="smaller ">2:30 <small>pm</small></div>
                                                </td>
                                                <td>
                                                    <div class="smaller ">Minor surgeries</div>
                                                </td>
                                                ...
                                                <td class="">
                                                    <div class="">
                                                        <a class="btn btn-primary btn-primary"
                                                            href="IPD_Patient_Details.html" style="color: white;"><span>
                        ...
                        <!-- <div class="element-actions">
                            <a class="btn btn-primary btn-primary" href="old_Patients.html "><i
                                    class="os-icon os-icon-ui-22"></i><span>OT Management</span></a>
                        </div> -->
    ...
    <script src="{{ asset('backend/evaluation/bower_components/jquery/dist/jquery.min.js') }}"></script>
<script src="{{ asset('backend/evaluation/bower_components/popper.js/dist/umd/popper.min.js') }}"></script>
<script src="{{ asset('backend/evaluation/bower_components/moment/moment.js') }}"></script>
<script src="{{ asset('backend/evaluation/bower_components/chart.js/dist/Chart.min.js') }}"></script>
<script src="{{ asset('backend/evaluation/bower_components/select2/dist/js/select2.full.min.js') }}"></script>
<script src="{{ asset('backend/evaluation/bower_components/jquery-bar-rating/dist/jquery.barrating.min.js') }}"></script>
<script src="{{ asset('backend/evaluation/bower_components/ckeditor/ckeditor.js') }}"></script>
<script src="{{ asset('backend/evaluation/bower_components/bootstrap-validator/dist/validator.min.js') }}"></script>
<script src="{{ asset('backend/evaluation/bower_components/bootstrap-daterangepicker/daterangepicker.js') }}"></script>
<script src="{{ asset('backend/evaluation/bower_components/ion.rangeSlider/js/ion.rangeSlider.min.js') }}"></script>
<script src="{{ asset('backend/evaluation/bower_components/dropzone/dist/dropzone.js') }}"></script>
<script src="{{ asset('backend/evaluation/bower_components/editable-table/mindmup-editabletable.js') }}"></script>
<script src="{{ asset('backend/evaluation/bower_components/datatables.net/js/jquery.dataTables.min.js') }}"></script>
<script src="{{ asset('backend/evaluation/bower_components/datatables.net-bs/js/dataTables.bootstrap.min.js') }}"></script>
<script src="{{ asset('backend/evaluation/bower_components/fullcalendar/dist/fullcalendar.min.js') }}"></script>
<script src="{{ asset('backend/evaluation/bower_components/perfect-scrollbar/js/perfect-scrollbar.jquery.min.js') }}"></script>
<script src="{{ asset('backend/evaluation/bower_components/tether/dist/js/tether.min.js') }}"></script>
<script src="{{ asset('backend/evaluation/bower_components/slick-carousel/slick/slick.min.js') }}"></script>
<script src="{{ asset('backend/evaluation/bower_components/bootstrap/js/dist/util.js') }}"></script>
<script src="{{ asset('backend/evaluation/bower_components/bootstrap/js/dist/alert.js') }}"></script>
<script src="{{ asset('backend/evaluation/bower_components/bootstrap/js/dist/button.js') }}"></script>
<script src="{{ asset('backend/evaluation/bower_components/bootstrap/js/dist/carousel.js') }}"></script>
<script src="{{ asset('backend/evaluation/bower_components/bootstrap/js/dist/collapse.js') }}"></script>
<script src="{{ asset('backend/evaluation/bower_components/bootstrap/js/dist/dropdown.js') }}"></script>
<script src="{{ asset('backend/evaluation/bower_components/bootstrap/js/dist/modal.js') }}"></script>
<script src="{{ asset('backend/evaluation/bower_components/bootstrap/js/dist/tab.js') }}"></script>
<script src="{{ asset('backend/evaluation/bower_components/bootstrap/js/dist/tooltip.js') }}"></script>
<script src="{{ asset('backend/evaluation/bower_components/bootstrap/js/dist/popover.js') }}"></script>
<script src="{{ asset('backend/evaluation/js/demo_customizer5739.js?version=4.5.0') }}"></script>
<script src="{{ asset('backend/evaluation/js/main5739.js?version=4.5.0') }}"></script>
...
<script>
    ...
    })(window, document, 'script', '{{ asset('backend/evaluation/www.google-analytics.com/analytics.js') }}', 'ga');
