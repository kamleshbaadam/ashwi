...
<head>
    ...
    <link href="{{ asset('backend/bedmanager/favicon.png') }}" rel="shortcut icon">
    <link href="{{ asset('backend/bedmanager/apple-touch-icon.png') }}" rel="apple-touch-icon">
    <link href="{{ asset('backend/bedmanager/fast.fonts.net/cssapi/487b73f1-c2d1-43db-8526-db577e4c822b.html') }}" rel="stylesheet">
    <link href="{{ asset('backend/bedmanager/bower_components/select2/dist/css/select2.min.css') }}" rel="stylesheet">
    <link href="{{ asset('backend/bedmanager/bower_components/bootstrap-daterangepicker/daterangepicker.css') }}" rel="stylesheet">
    <link href="{{ asset('backend/bedmanager/bower_components/dropzone/dist/dropzone.css') }}" rel="stylesheet">
    <link href="{{ asset('backend/bedmanager/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css') }}" rel="stylesheet">
    <link href="{{ asset('backend/bedmanager/bower_components/fullcalendar/dist/fullcalendar.min.css') }}" rel="stylesheet">
    <link href="{{ asset('backend/bedmanager/bower_components/perfect-scrollbar/css/perfect-scrollbar.min.css') }}" rel="stylesheet">
    <link href="{{ asset('backend/bedmanager/bower_components/slick-carousel/slick/slick.css') }}" rel="stylesheet">
    <link href="{{ asset('backend/bedmanager/css/main5739.css?version=4.5.0') }}" rel="stylesheet">
...
<body class="menu-position-top full-screen with-content-panel">
            ...
            <div class="menu-w color-scheme-light 
                ...
                <ul class="main-menu">
                    ...
                    <li class="has-sub-menu"><a>
                            <div class="icon-w">
                                <div class="os-icon os-icon-layers"></div>
                            </div><span>IPD Patient</span>
                        </a>
                        <div class="sub-menu-w">
                            <div class="sub-menu-header">IPD Patient</div>
                            <div class="sub-menu-icon"><i class="os-icon os-icon-layers"></i></div>
                            <div class="sub-menu-i">
                                <ul class="sub-menu">
                                    <li><a href="IPD_patients.html">IPD Patient </a></li>
    ...
    <script src="{{ asset('backend/bedmanager/bower_components/jquery/dist/jquery.min.js') }}"></script>
<script src="{{ asset('backend/bedmanager/bower_components/popper.js/dist/umd/popper.min.js') }}"></script>
<script src="{{ asset('backend/bedmanager/bower_components/moment/moment.js') }}"></script>
<script src="{{ asset('backend/bedmanager/bower_components/chart.js/dist/Chart.min.js') }}"></script>
<script src="{{ asset('backend/bedmanager/bower_components/select2/dist/js/select2.full.min.js') }}"></script>
<script src="{{ asset('backend/bedmanager/bower_components/jquery-bar-rating/dist/jquery.barrating.min.js') }}"></script>
<script src="{{ asset('backend/bedmanager/bower_components/ckeditor/ckeditor.js') }}"></script>
<script src="{{ asset('backend/bedmanager/bower_components/bootstrap-validator/dist/validator.min.js') }}"></script>
<script src="{{ asset('backend/bedmanager/bower_components/bootstrap-daterangepicker/daterangepicker.js') }}"></script>
<script src="{{ asset('backend/bedmanager/bower_components/ion.rangeSlider/js/ion.rangeSlider.min.js') }}"></script>
<script src="{{ asset('backend/bedmanager/bower_components/dropzone/dist/dropzone.js') }}"></script>
<script src="{{ asset('backend/bedmanager/bower_components/editable-table/mindmup-editabletable.js') }}"></script>
<script src="{{ asset('backend/bedmanager/bower_components/datatables.net/js/jquery.dataTables.min.js') }}"></script>
<script src="{{ asset('backend/bedmanager/bower_components/datatables.net-bs/js/dataTables.bootstrap.min.js') }}"></script>
<script src="{{ asset('backend/bedmanager/bower_components/fullcalendar/dist/fullcalendar.min.js') }}"></script>
<script src="{{ asset('backend/bedmanager/bower_components/perfect-scrollbar/js/perfect-scrollbar.jquery.min.js') }}"></script>
<script src="{{ asset('backend/bedmanager/bower_components/tether/dist/js/tether.min.js') }}"></script>
<script src="{{ asset('backend/bedmanager/bower_components/slick-carousel/slick/slick.min.js') }}"></script>
<script src="{{ asset('backend/bedmanager/bower_components/bootstrap/js/dist/util.js') }}"></script>
<script src="{{ asset('backend/bedmanager/bower_components/bootstrap/js/dist/alert.js') }}"></script>
<script src="{{ asset('backend/bedmanager/bower_components/bootstrap/js/dist/button.js') }}"></script>
<script src="{{ asset('backend/bedmanager/bower_components/bootstrap/js/dist/carousel.js') }}"></script>
<script src="{{ asset('backend/bedmanager/bower_components/bootstrap/js/dist/collapse.js') }}"></script>
<script src="{{ asset('backend/bedmanager/bower_components/bootstrap/js/dist/dropdown.js') }}"></script>
<script src="{{ asset('backend/bedmanager/bower_components/bootstrap/js/dist/modal.js') }}"></script>
<script src="{{ asset('backend/bedmanager/bower_components/bootstrap/js/dist/tab.js') }}"></script>
<script src="{{ asset('backend/bedmanager/bower_components/bootstrap/js/dist/tooltip.js') }}"></script>
<script src="{{ asset('backend/bedmanager/bower_components/bootstrap/js/dist/popover.js') }}"></script>
<script src="{{ asset('backend/bedmanager/js/demo_customizer5739.js?version=4.5.0') }}"></script>
<script src="{{ asset('backend/bedmanager/js/main5739.js?version=4.5.0') }}"></script>
...
<script>
    ...
    })(window, document, 'script', '{{ asset('backend/bedmanager/www.google-analytics.com/analytics.js') }}', 'ga');
